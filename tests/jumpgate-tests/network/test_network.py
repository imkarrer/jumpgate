...
class TestNetworksV2(unittest.TestCase):
    ...
    def check_response_body(self, resp_body_network):
        ...
        self.assertEqual(resp_body_network['provider:segmentation_id'], 11)
        self.assertIsNotNone(resp_body_network['provider:physical_network'])

    def test_on_get_response_networkv2(self):
    ...
    def test_on_get_response_networkv2_show(self):
        """Test show function in NetworkV2"""
